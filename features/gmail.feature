Feature: Gmail
  ...
  Background:
    Given there are the following users:
      ...
      | mgswolf@gmail.com  | password |
    And Action Mailer delivers via SMTP
    Given there is a project called "TextMate 2"
    And "alice@ticketee.com" can view the "TextMate 2" project
    And "mgswolf@gmail.com" can view the "TextMate 2" project
    And "mgswolf@gmail.com" has created a ticket for this project:
      | title        | description       |
  ...
  Scenario: Receiving a real-world email
    ...
    When I log into gmail with:
      | username          | password      |
      | mgswolf@gmail.com | mgswolf123844 |
